...
**Day 4**
 ...
 At this stage, I believe I have almost completed the project. However, to further improve my project, I will further research on different plugins that I could use to create an even faster and controlled website. Therefore, the next time I work on this project I will be aiming to work on more plugins as well as fine tunning my blog/resume site.
...
After concluding that WordPress can sometimes be slow to load up through the confirmation of emailing the MSA team, I have decided to add a plugin that can detect traffic or any malicious users in my site. This plugin will be explained further later in the Plugins section. Therefore, today with the improvement of the speed, I believe it is safe for me to submit my work without stress. 
